# Cisco Packet Tracer: Multi-Router DHCP Configuration Lab

## 📌 Project Overview
This project demonstrates the configuration of **Dynamic Host Configuration Protocol (DHCP)** across a multi-router network topology. 
...
| **Router1** | Fa0/0 | 192.168.11.1 | 255.255.255.0 | Gateway for LAN 1 (Central) |
...
Router2 Configuration (Relay Agent)
